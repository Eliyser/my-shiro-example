package com.haien.chapter24.web.taglib;
...
import com.haien.chapter24.service.OrganizationService;
...
public class Functions {
    ...
    /**
     * @Author haien
     * @Description 根据会话获取当前用户的用户名集合，并返回第一个作为用户名
     * @Date 2019/5/9
     * @Param [session]

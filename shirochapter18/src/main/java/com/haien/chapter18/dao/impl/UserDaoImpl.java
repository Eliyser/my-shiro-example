package com.haien.chapter18.dao.impl;

import com.haien.chapter18.dao.UserDao;
import com.haien.chapter18.entity.User;
...
public class UserDaoImpl implements UserDao {
    ...
    public User createUser(final User user) {
        final String sql = "insert into sys_user(organization_id, username, password, salt, " +
                "role_ids, locked) values(?,?,?,?,?,?)";
    ...
    public User updateUser(User user) {
        String sql = "update sys_user set organization_id=?,username=?, password=?, salt=?, " +
                "role_ids=?, locked=? where id=?";
        jdbcTemplate.update(
                sql,
                user.getOrganizationId(), user.getUsername(), user.getPassword(),
    ...
    public List<User> findAll() {
        String sql = "select id, organization_id, username, password, salt, role_ids " +
                "as roleIdsStr, locked from sys_user";
    ...
    public User findByUsername(String username) {
        String sql = "select id, organization_id, username, password, salt, role_ids " +
                "as roleIdsStr, locked from sys_user where username=?";
        List<User> userList = jdbcTemplate.query(sql,

package com.haien.chapter19.web.controller;

import com.haien.chapter19.entity.Resource;
import com.haien.chapter19.service.ResourceService;
...
public class ResourceController {
    ...
    /**
     * @Author haien
     * @Description 将方法返回值存入Model中，属性名为types，在edit.jsp中取出：${types}
     * @Date 2019/3/15
     * @Param []
     * @return com.haien.chapter16.entity.Resource.ResourceType[]
     **/

package com.haien.chapter17.dao.impl;

import com.haien.chapter17.dao.ClientDao;
...
public class ClientDaoImpl implements ClientDao {
    ...
    public Client createClient(final Client client) {
        final String sql = "insert into oauth2_client(client_name, client_id, client_secret) " +
                "values(?,?,?)";
    ...
    public Client updateClient(Client client) {
        String sql = "update oauth2_client set client_name=?, client_id=?, client_secret=? " +
                "where id=?";
        jdbcTemplate.update(
                sql,

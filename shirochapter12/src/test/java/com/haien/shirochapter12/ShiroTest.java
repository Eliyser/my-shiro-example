package com.haien.shirochapter12;
...
@ContextConfiguration(locations = {"classpath:spring-beans.xml","classpath:spring-shiro.xml"}) //指定bean注入的配置文件
@Transactional
public class ShiroTest {
    ...
    @Autowired //该方法被自动调用，并注入DataSource的bean
